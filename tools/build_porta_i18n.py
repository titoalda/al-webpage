...
EN = [
    ...
    # gallery2 (39-photo set, 2026-07)
    ('alt="Fotografía editorial de Porta"', 'alt="Porta editorial photography"'),
    ('alt="Icono del arco de Porta"', 'alt="Porta arch icon"'),
    ('alt="Icono del barco de Porta"', 'alt="Porta ship icon"'),
    ('alt="Icono de la ola de Porta"', 'alt="Porta wave icon"'),
    ('alt="Ilustración a&nbsp;acuarela de Porta"', 'alt="Porta watercolour illustration"'),
    ('alt="Doble página interior de Porta"', 'alt="Porta interior spread"'),
    ('alt="Logotipo de Porta con descriptor Cuadernos de&nbsp;Identidad Baionesa"',
     'alt="Porta logo with descriptor Cuadernos de&nbsp;Identidad Baionesa"'),
    ('alt="Mockup editorial horizontal de Porta"', 'alt="Porta horizontal editorial mockup"'),
    ('alt="Mockup editorial vertical de Porta"', 'alt="Porta vertical editorial mockup"'),
    ('alt="Mockup de la identidad de Porta aplicada a&nbsp;un entorno digital"',
     "alt=\"Mockup of Porta's identity applied to a digital environment\""),
    ('alt="Estuche de Porta"', 'alt="Porta slipcase"'),
    # cta + footer
...
GL = [
    ...
    # gallery2 (39-photo set, 2026-07)
    ('alt="Fotografía editorial de Porta"', 'alt="Fotografía editorial de Porta"'),
    ('alt="Icono del arco de Porta"', 'alt="Icona do arco de Porta"'),
    ('alt="Icono del barco de Porta"', 'alt="Icona do barco de Porta"'),
    ('alt="Icono de la ola de Porta"', 'alt="Icona da onda de Porta"'),
    ('alt="Ilustración a&nbsp;acuarela de Porta"', 'alt="Ilustración á&nbsp;acuarela de Porta"'),
    ('alt="Doble página interior de Porta"', 'alt="Dobre páxina interior de Porta"'),
    ('alt="Logotipo de Porta con descriptor Cuadernos de&nbsp;Identidad Baionesa"',
     'alt="Logotipo de Porta co&nbsp;descritor Cuadernos de&nbsp;Identidad Baionesa"'),
    ('alt="Mockup editorial horizontal de Porta"', 'alt="Mockup editorial horizontal de Porta"'),
    ('alt="Mockup editorial vertical de Porta"', 'alt="Mockup editorial vertical de Porta"'),
    ('alt="Mockup de la identidad de Porta aplicada a&nbsp;un entorno digital"',
     'alt="Mockup da identidade de Porta aplicada a&nbsp;unha contorna dixital"'),
    ('alt="Estuche de Porta"', 'alt="Estoxo de Porta"'),
    # cta + footer
